...
import ru.practicum.shareit.error.IdNotFoundException;
...
class ItemServiceImplTest {
    ...
    Booking secondBooking = new Booking(2, date.plusDays(2), date.plusDays(3), item, user, Status.WAITING.toString());
